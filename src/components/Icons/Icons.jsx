export function QuoteIcon({ size = 18 }) {
  return (
    <svg
      width={size}
      height={size}
...
export function WhatsAppIcon({ size = 18 }) {
  return (
    ...
    >
      <path
        d="M20 11.5a8 8 0 0 1-11.85 7L4 20l1.5-4A8 8 0 1 1 20 11.5Z"
        stroke="currentColor"
        strokeWidth="1.8"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path
        d="M9 8.5c.5 2.8 1.8 4.2 4.5 5.5"
        stroke="currentColor"
        strokeWidth="1.8"
        strokeLinecap="round"
      />
...
export function MeasureIcon({ size = 20 }) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <path
        d="m13 8 3 3M10 11l2 2M7 14l3 3"
        stroke="currentColor"
        strokeWidth="1.6"
      />
    </svg>
...
export function HiddenFixingIcon({ size = 20 }) {
  return (
    <svg
      width={size}
      height={size}
...
export function LightningIcon({ size = 16 }) {
  return (
    <svg
      width={size}
      height={size}
...
export function TuneIcon({ size = 16 }) {
  return (
    <svg
      width={size}
      height={size}
...
export function ToolsIcon({ size = 16 }) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <path
        d="M9 5a4 4 0 0 0-5 5l10 10 5-5L9 5Z"
        stroke="currentColor"
        strokeWidth="1.8"
        strokeLinejoin="round"
      />
...
export function PhoneIcon({ size = 18 }) {
  return (
    ...
    >
      <path
        d="M7 3H4a1 1 0 0 0-1 1c0 9.4 7.6 17 17 17a1 1 0 0 0 1-1v-3l-4-1-1.5 2a14.3 14.3 0 0 1-9.5-9.5L8 7 7 3Z"
        stroke="currentColor"
        strokeWidth="1.8"
        strokeLinecap="round"
        strokeLinejoin="round"
...
export function RoofIcon({ size = 18 }) {
  return (
    <svg
      width={size}
      height={size}
...
export function ArchitectureIcon({ size = 18 }) {
  return (
    <svg
      width={size}
      height={size}
...
export function BuildingIcon({ size = 18 }) {
  return (
    ...
    >
      <path
        d="M5 21V3h10v18M15 8h4v13M3 21h18"
        stroke="currentColor"
        strokeWidth="1.8"
        strokeLinecap="round"
        strokeLinejoin="round"
...
export function LinkIcon({ size = 18 }) {
  return (
    ...
    >
      <path
        d="M10 13a4 4 0 0 0 5.7 0l2.3-2.3a4 4 0 0 0-5.7-5.7L11 6"
        stroke="currentColor"
        strokeWidth="1.8"
        strokeLinecap="round"
      />
      <path
        d="M14 11a4 4 0 0 0-5.7 0L6 13.3A4 4 0 0 0 11.7 19L13 18"
        stroke="currentColor"
        strokeWidth="1.8"
        strokeLinecap="round"
      />
...
export function UsersIcon({ size = 18 }) {
  return (
    ...
    >
      ...
      />
      <path
        d="M3 20c0-4 2.4-6 6-6s6 2 6 6M14 15c3.3 0 5 1.6 5 5"
        stroke="currentColor"
        strokeWidth="1.8"
        strokeLinecap="round"
      />
...
export function UserIcon({ size = 18 }) {
  return (
    ...
    >
      ...
      <path
        d="M4.5 21c.7-4.2 3.2-6.5 7.5-6.5s6.8 2.3 7.5 6.5"
        stroke="currentColor"
        strokeWidth="1.8"
        strokeLinecap="round"
      />
